...
from ..aux.auxFunctions import read_input
...
def makeWeightPlot(wMode,
    ...
    label_names = {
        ...
        'stim_1': 'Stimulus Prior (-1)',
        'avg_stim': 'Average Stimulus',
        'stim_2': 'Stimulus Prior (-2)',
        'StimulusStrength*RewardHistory': 'StimulusStrength • RewardHistory',
    ...
    label_order = {
        ...
        'stim_2': 4,
        'avg_stim': 5,
        'StimulusStrength*RewardHistory': 6,
    ...
    colors = {
        'bias': '#1982C4',
        'stimulus_strength': '#FF595E',
        'avg_stim': '#FFCA3A',
        'stim_2': '#A4036F',
        'stim_1': '#7353BA',
        'reward_history': '#8AC926',
        'StimulusStrength*RewardHistory': '#FFCA3A',
    ...
    if 'dataset' not in outData:
        plot_title = ""
    elif "Human" in outData['dataset']:
        plot_title = "Human "
    elif "Rat" in outData['dataset']:
        plot_title = "Rat "
    elif "Mouse" in outData['dataset']:
        plot_title = "Mouse "
    else:
        plot_title = ""
