...
def generateSim(K=4, N=64000, hyper={}, boundary=4.0, iterations=20, seed=None, savePath=None):
    ...
    # Reproducability
    np.random.seed(seed) #this makes the same "random" numbers appear every time so the generatesim is the same
